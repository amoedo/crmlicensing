...
// </copyright>
// <author></author>
// <date>1/20/2013 4:44:12 PM</date>
...
namespace CrmLicensing.CrmPackageByKey.Plugins
{
    ...
    public class PreAccountCreate: Plugin
    {
        ...
        protected void ExecutePreAccountCreate(LocalPluginContext localContext)
        {
            ...
            if (!target.Contains("clbk_vatnumber"))
            {
            ...
            string vat = (string)target["clbk_vatnumber"];
